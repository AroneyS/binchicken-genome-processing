...
strain_purity_data <- bind_rows(
  strain_purity_separate %>% select(coassembly, gene, representative, total_num_reads, num_sub_otus, max_sub_otu_abundance) %>% mutate(assembly_set = "single"),
  strain_purity_combined %>% select(coassembly, gene, representative, total_num_reads, num_sub_otus, max_sub_otu_abundance) %>% mutate(assembly_set = "coassembly"),
  ) %>%
  mutate(
    assembly_set = factor(assembly_set, levels = assembly_set_levels),
