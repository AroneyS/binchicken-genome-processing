...
MAGSET_ORDER = [
    # "GTDB", # GB_GCA_016935655.1
    "UHGG", # MGYG000003541
    "GEM", # 3300027742_44
    "OceanDNA", # TARA_SAMEA2619974_METAG_DHAIHCHF
    "SPIRE", # spire_mag_01842612
    "SMAG", # SRR11742948bin.25
    "Tengchong", # GCA_038727015.1_ASM3872701v1_genomic
    "binchicken", # binchicken_co19_513
]
...
class Tests(unittest.TestCase):
    ...
    def test_name_clades(self):
        ...
        tree_df = pl.DataFrame([
            [10, 1, "nongtdb", "spire_mag_1", "SPIRE", None, None],
            [10, 2, "nongtdb", "binchicken_co1_1", "binchicken", None, None],
            [1000, 3, "nongtdb", "binchicken_co1_2", "binchicken", None, None],
        ...
        genome_metadata = pl.DataFrame([
            ["spire_mag_1", 90.0, 0.0],
            ["binchicken_co1_1", 90.0, 0.0],
            ["binchicken_co1_2", 90.0, 5.0],
        ], schema=GENOME_METADATA_COLUMNS)

        expected_genomes = pl.DataFrame([
            ["spire_mag_1", "d__Bacteria;p__SPIRE_b1;c__SPIRE_b1;o__SPIRE_b1;f__SPIRE_b1;g__SPIRE_b1;s__SPIRE_b1 spire_mag_1"],
            ["binchicken_co1_1", "d__Bacteria;p__SPIRE_b1;c__SPIRE_b1;o__SPIRE_b1;f__SPIRE_b1;g__SPIRE_b1;s__SPIRE_b1 binchicken_co1_1"],
            ["binchicken_co1_2", "d__Bacteria;p__SPIRE_b1;c__SPIRE_b1;o__SPIRE_b1;f__SPIRE_b1;g__binchicken_b1;s__binchicken_b1 binchicken_co1_2"],
        ], schema=GENOMES_OUTPUT_COLUMNS)
        expected_nodes = pl.DataFrame([
            [100000, "p__SPIRE_b1", "spire_mag_1"],
            [100000, "c__SPIRE_b1", "spire_mag_1"],
            [1000, "o__SPIRE_b1", "spire_mag_1"],
            [1000, "f__SPIRE_b1", "spire_mag_1"],
            [10, "g__SPIRE_b1", "spire_mag_1"],
            [None, "s__SPIRE_b1 spire_mag_1", "spire_mag_1"],
            [None, "s__SPIRE_b1 binchicken_co1_1", "binchicken_co1_1"],
            [None, "g__binchicken_b1", "binchicken_co1_2"],
            [None, "s__binchicken_b1 binchicken_co1_2", "binchicken_co1_2"],
        ], schema=NODES_OUTPUT_COLUMNS)
    ...
    def test_name_clades_all_magsets(self):
        ...
        tree_df = pl.DataFrame([
            ...
            [20, 4, "nongtdb", "TARA_SAMEA2619974_METAG_DHAIHCHF", "OceanDNA", None, None],
            [30, 5, "nongtdb", "binchicken_co19_513", "binchicken", None, None],
            [30, 6, "nongtdb", "TARA_SAMEA2619974_METAG_DHAIHCHC", "OceanDNA", None, None],
        ...
        ], schema=TREE_INPUT_COLUMNS)
        genome_metadata = pl.DataFrame([
            ["spire_mag_1", 95.0, 0.0],
            ["MGYG000003541", 90.0, 0.0],
            ["SRR11742948bin.25", 90.0, 0.0],
            ["TARA_SAMEA2619974_METAG_DHAIHCHF", 95.0, 0.0],
            ["binchicken_co19_513", 95.0, 0.0],
            ["TARA_SAMEA2619974_METAG_DHAIHCHC", 90.0, 1.0],
            ["MGYG000003542", 90.0, 1.0],
        ], schema=GENOME_METADATA_COLUMNS)

        expected_genomes = pl.DataFrame([
            ["spire_mag_1", "d__Archaea;p__UHGG_a1;c__UHGG_a1;o__UHGG_a1;f__UHGG_a1;g__UHGG_a1;s__UHGG_a1 spire_mag_1"],
            ["MGYG000003541", "d__Archaea;p__UHGG_a1;c__UHGG_a1;o__UHGG_a1;f__UHGG_a1;g__UHGG_a1;s__UHGG_a1 MGYG000003541"],
            ["SRR11742948bin.25", "d__Archaea;p__UHGG_a1;c__UHGG_a1;o__UHGG_a1;f__UHGG_a1;g__OceanDNA_a1;s__OceanDNA_a1 SRR11742948bin.25"],
            ["TARA_SAMEA2619974_METAG_DHAIHCHF", "d__Archaea;p__UHGG_a1;c__UHGG_a1;o__UHGG_a1;f__UHGG_a1;g__OceanDNA_a1;s__OceanDNA_a1 TARA_SAMEA2619974_METAG_DHAIHCHF"],
            ["binchicken_co19_513", "d__Archaea;p__UHGG_a1;c__UHGG_a2;o__UHGG_a2;f__UHGG_a2;g__OceanDNA_a2;s__OceanDNA_a2 binchicken_co19_513"],
            ["TARA_SAMEA2619974_METAG_DHAIHCHC", "d__Archaea;p__UHGG_a1;c__UHGG_a2;o__UHGG_a2;f__UHGG_a2;g__OceanDNA_a2;s__OceanDNA_a2 TARA_SAMEA2619974_METAG_DHAIHCHC"],
            ["MGYG000003542", "d__Archaea;p__UHGG_a1;c__UHGG_a2;o__UHGG_a2;f__UHGG_a2;g__UHGG_a2;s__UHGG_a2 MGYG000003542"],
        ], schema=GENOMES_OUTPUT_COLUMNS)
        expected_nodes = pl.DataFrame([
            [100000, "p__UHGG_a1", "MGYG000003541"],
            [20000, "c__UHGG_a2", "MGYG000003542"],
            [20000, "o__UHGG_a2", "MGYG000003542"],
            [20000, "f__UHGG_a2", "MGYG000003542"],
            [10000, "c__UHGG_a1", "MGYG000003541"],
            [10000, "o__UHGG_a1", "MGYG000003541"],
            [10000, "f__UHGG_a1", "MGYG000003541"],
            [30, "g__OceanDNA_a2", "TARA_SAMEA2619974_METAG_DHAIHCHC"],
            [20, "g__OceanDNA_a1", "TARA_SAMEA2619974_METAG_DHAIHCHF"],
            [10, "g__UHGG_a1", "MGYG000003541"],
            [None, "g__UHGG_a2", "MGYG000003542"],
            [None, "s__OceanDNA_a2 TARA_SAMEA2619974_METAG_DHAIHCHC", "TARA_SAMEA2619974_METAG_DHAIHCHC"],
            [None, "s__OceanDNA_a2 binchicken_co19_513", "binchicken_co19_513"],
            [None, "s__OceanDNA_a1 TARA_SAMEA2619974_METAG_DHAIHCHF", "TARA_SAMEA2619974_METAG_DHAIHCHF"],
            [None, "s__OceanDNA_a1 SRR11742948bin.25", "SRR11742948bin.25"],
            [None, "s__UHGG_a1 MGYG000003541", "MGYG000003541"],
            [None, "s__UHGG_a1 spire_mag_1", "spire_mag_1"],
            [None, "s__UHGG_a2 MGYG000003542", "MGYG000003542"],
        ], schema=NODES_OUTPUT_COLUMNS)
    ...
    def test_name_clades_gtdb_truncate(self):
        ...
        tree_df = pl.DataFrame([
            ...
            [10000, 3, "nongtdb", "spire_mag_1", "SPIRE", None, None],
            [10000, 10, "gtdb", None, None, 1, NOVELTY_RED_LEVELS[0]],
        ...
        expected_genomes = pl.DataFrame([
            ["spire_mag_1", "10000;g__SPIRE_a1;s__SPIRE_a1 spire_mag_1"],
        ], schema=GENOMES_OUTPUT_COLUMNS)
        expected_nodes = pl.DataFrame([
            [None, "g__SPIRE_a1", "spire_mag_1"],
            [None, "s__SPIRE_a1 spire_mag_1", "spire_mag_1"],
        ], schema=NODES_OUTPUT_COLUMNS)
    ...
    def test_name_clades_gtdb_truncate_early(self):
        ...
        tree_df = pl.DataFrame([
            [10, 1, "gtdb", "GB_GCA_016935655.1", None, None, None],
            [10, 2, "gtdb", "GB_GCA_016935655.2", None, None, None],
            [20, 3, "nongtdb", "spire_mag_1", "SPIRE", None, None],
    ...
    def test_name_clades_gtdb_novel_phyla(self):
        ...
        tree_df = pl.DataFrame([
            [10, 1, "gtdb", "GB_GCA_016935655.1", None, None, None],
            [10, 2, "gtdb", "GB_GCA_016935655.2", None, None, None],
            [10000, 3, "nongtdb", "binchicken_co184_218", "binchicken", None, None],
            [10000, 10, "gtdb", None, None, 1, NOVELTY_RED_LEVELS[0]],
            [0, 10000, "gtdb", None, None, 0.21, NOVELTY_RED_LEVELS[5]],
            [0, 0, "gtdb", None, None, 0.15, NOVELTY_RED_LEVELS[5]],
        ], schema=TREE_INPUT_COLUMNS)
        genome_metadata = pl.DataFrame([
            ["binchicken_co184_218", 90.0, 0.0],
        ], schema=GENOME_METADATA_COLUMNS)

        expected_genomes = pl.DataFrame([
            ["binchicken_co184_218", "d__Archaea;p__binchicken_a1;c__binchicken_a1;o__binchicken_a1;f__binchicken_a1;g__binchicken_a1;s__binchicken_a1 binchicken_co184_218"],
        ], schema=GENOMES_OUTPUT_COLUMNS)
        expected_nodes = pl.DataFrame([
            [None, "p__binchicken_a1", "binchicken_co184_218"],
            [None, "c__binchicken_a1", "binchicken_co184_218"],
            [None, "o__binchicken_a1", "binchicken_co184_218"],
            [None, "f__binchicken_a1", "binchicken_co184_218"],
            [None, "g__binchicken_a1", "binchicken_co184_218"],
            [None, "s__binchicken_a1 binchicken_co184_218", "binchicken_co184_218"],
        ], schema=NODES_OUTPUT_COLUMNS)
    ...
    def test_name_clades_gtdb_almost_novel_phyla(self):
        ...
        tree_df = pl.DataFrame([
            [10, 1, "gtdb", "GB_GCA_016935655.1", None, None, None],
            [10, 2, "gtdb", "GB_GCA_016935655.2", None, None, None],
            [20, 3, "nongtdb", "binchicken_co184_218", "binchicken", None, None],
            [20, 10, "gtdb", None, None, 1, NOVELTY_RED_LEVELS[0]],
        ...
        expected_genomes = pl.DataFrame([
            ["binchicken_co184_218", "20;c__binchicken_a1;o__binchicken_a1;f__binchicken_a1;g__binchicken_a1;s__binchicken_a1 binchicken_co184_218"],
        ], schema=GENOMES_OUTPUT_COLUMNS)
        expected_nodes = pl.DataFrame([
            [None, "c__binchicken_a1", "binchicken_co184_218"],
            [None, "o__binchicken_a1", "binchicken_co184_218"],
    ...
    def test_name_clades_gtdb_almost_novel_phyla_further(self):
        ...
        tree_df = pl.DataFrame([
            [10, 1, "gtdb", "GB_GCA_016935655.1", None, None, None],
            [10, 2, "gtdb", "GB_GCA_016935655.2", None, None, None],
            [40, 3, "nongtdb", "binchicken_co184_218", "binchicken", None, None],
            [20, 10, "gtdb", None, None, 1, NOVELTY_RED_LEVELS[0]],
        ...
        expected_genomes = pl.DataFrame([
            ["binchicken_co184_218", "40;c__binchicken_a1;o__binchicken_a1;f__binchicken_a1;g__binchicken_a1;s__binchicken_a1 binchicken_co184_218"],
        ], schema=GENOMES_OUTPUT_COLUMNS)
        expected_nodes = pl.DataFrame([
            [None, "c__binchicken_a1", "binchicken_co184_218"],
            [None, "o__binchicken_a1", "binchicken_co184_218"],
    ...
    def test_name_clades_better_node(self):
        ...
        tree_df = pl.DataFrame([
            [10, 1, "nongtdb", "spire_mag_1", "SPIRE", None, None],
            [10, 2, "nongtdb", "binchicken_co1_1", "binchicken", None, None],
            [20, 3, "nongtdb", "binchicken_co1_2", "binchicken", None, None],
        ...
        expected_genomes = pl.DataFrame([
            ["spire_mag_1", "d__Bacteria;p__SPIRE_b1;c__SPIRE_b1;o__SPIRE_b1;f__SPIRE_b1;g__SPIRE_b1;s__SPIRE_b1 spire_mag_1"],
            ["binchicken_co1_1", "d__Bacteria;p__SPIRE_b1;c__SPIRE_b1;o__SPIRE_b1;f__SPIRE_b1;g__SPIRE_b1;s__SPIRE_b1 binchicken_co1_1"],
            ["binchicken_co1_2", "d__Bacteria;p__SPIRE_b1;c__SPIRE_b1;o__SPIRE_b1;f__SPIRE_b1;g__SPIRE_b1;s__SPIRE_b1 binchicken_co1_2"],
        ], schema=GENOMES_OUTPUT_COLUMNS)
        expected_nodes = pl.DataFrame([
            [100000, "p__SPIRE_b1", "spire_mag_1"],
            [100000, "c__SPIRE_b1", "spire_mag_1"],
            [100000, "o__SPIRE_b1", "spire_mag_1"],
            [100000, "f__SPIRE_b1", "spire_mag_1"],
            [20, "g__SPIRE_b1", "spire_mag_1"],
            [None, "s__SPIRE_b1 spire_mag_1", "spire_mag_1"],
            [None, "s__SPIRE_b1 binchicken_co1_1", "binchicken_co1_1"],
            [None, "s__SPIRE_b1 binchicken_co1_2", "binchicken_co1_2"],
        ], schema=NODES_OUTPUT_COLUMNS)
    ...
    def test_name_clades_better_node_but_later(self):
        ...
        tree_df = pl.DataFrame([
            [200, 1, "nongtdb", "binchicken_co1_1", "binchicken", None, None],
            [200, 2, "nongtdb", "binchicken_co1_2", "binchicken", None, None],
            [100, 3, "nongtdb", "binchicken_co1_3", "binchicken", None, None],
            [100, 4, "nongtdb", "binchicken_co1_4", "binchicken", None, None],
            [200, 5, "nongtdb", "binchicken_co1_5", "binchicken", None, None],
        ...
        genome_metadata = pl.DataFrame([
            ["binchicken_co1_1", 95.0, 0.0],
            ["binchicken_co1_2", 94.0, 0.0],
            ["binchicken_co1_3", 93.0, 0.0],
            ["binchicken_co1_4", 92.0, 0.0],
            ["binchicken_co1_5", 91.0, 0.0],
        ], schema=GENOME_METADATA_COLUMNS)

        expected_genomes = pl.DataFrame([
            ["binchicken_co1_1", "d__Bacteria;p__binchicken_b1;c__binchicken_b1;o__binchicken_b1;f__binchicken_b1;g__binchicken_b1;s__binchicken_b1 binchicken_co1_1"],
            ["binchicken_co1_2", "d__Bacteria;p__binchicken_b1;c__binchicken_b1;o__binchicken_b1;f__binchicken_b2;g__binchicken_b2;s__binchicken_b2 binchicken_co1_2"],
            ["binchicken_co1_3", "d__Bacteria;p__binchicken_b1;c__binchicken_b1;o__binchicken_b1;f__binchicken_b3;g__binchicken_b3;s__binchicken_b3 binchicken_co1_3"],
            ["binchicken_co1_4", "d__Bacteria;p__binchicken_b1;c__binchicken_b1;o__binchicken_b1;f__binchicken_b3;g__binchicken_b4;s__binchicken_b4 binchicken_co1_4"],
            ["binchicken_co1_5", "d__Bacteria;p__binchicken_b1;c__binchicken_b1;o__binchicken_b1;f__binchicken_b4;g__binchicken_b5;s__binchicken_b5 binchicken_co1_5"],
        ], schema=GENOMES_OUTPUT_COLUMNS)
        expected_nodes = pl.DataFrame([
            [100000, "p__binchicken_b1", "binchicken_co1_1"],
            [100000, "c__binchicken_b1", "binchicken_co1_1"],
            [100000, "o__binchicken_b1", "binchicken_co1_1"],
            [None, "f__binchicken_b1", "binchicken_co1_1"],
            [None, "f__binchicken_b2", "binchicken_co1_2"],
            [100, "f__binchicken_b3", "binchicken_co1_3"],
            [None, "f__binchicken_b4", "binchicken_co1_5"],
            [None, "g__binchicken_b1", "binchicken_co1_1"],
            [None, "g__binchicken_b2", "binchicken_co1_2"],
            [None, "g__binchicken_b3", "binchicken_co1_3"],
            [None, "g__binchicken_b4", "binchicken_co1_4"],
            [None, "g__binchicken_b5", "binchicken_co1_5"],
            [None, "s__binchicken_b1 binchicken_co1_1", "binchicken_co1_1"],
            [None, "s__binchicken_b2 binchicken_co1_2", "binchicken_co1_2"],
            [None, "s__binchicken_b3 binchicken_co1_3", "binchicken_co1_3"],
            [None, "s__binchicken_b4 binchicken_co1_4", "binchicken_co1_4"],
            [None, "s__binchicken_b5 binchicken_co1_5", "binchicken_co1_5"],
        ], schema=NODES_OUTPUT_COLUMNS)
    ...
    def test_name_clades_extra_phyla(self):
        tree_df = pl.DataFrame([
            ...
            [275363, 83729, "gtdb", "GB_GCA_023135745.1", None, 1, NOVELTY_RED_LEVELS[0]],
        ...
        expected_genomes = pl.DataFrame([
            ["ERP107533_co1_57", "275361;c__binchicken_b1;o__binchicken_b1;f__binchicken_b2;g__binchicken_b3;s__binchicken_b3 ERP107533_co1_57"],
            ["SRP141376_co3_207", "275361;c__binchicken_b1;o__binchicken_b1;f__binchicken_b1;g__binchicken_b2;s__binchicken_b2 SRP141376_co3_207"],
            ["spire_mag_01765318", "275363;o__GEM_b1;f__GEM_b1;g__SPIRE_b2;s__SPIRE_b2 spire_mag_01765318"],
            ["binchicken_co117_471", "275363;o__GEM_b1;f__GEM_b1;g__binchicken_b1;s__binchicken_b1 binchicken_co117_471"],
            ["3300025882_39", "275363;o__GEM_b1;f__GEM_b1;g__GEM_b1;s__GEM_b1 3300025882_39"],
            ["binchicken_co111_474", "275363;o__GEM_b1;f__GEM_b1;g__GEM_b1;s__GEM_b1 binchicken_co111_474"],
            ["spire_mag_02020990", "275363;o__GEM_b1;f__SPIRE_b1;g__SPIRE_b1;s__SPIRE_b1 spire_mag_02020990"],
        ], schema=GENOMES_OUTPUT_COLUMNS)
        expected_nodes = pl.DataFrame([
            [275362, "c__binchicken_b1", "SRP141376_co3_207"],
            [275364, "o__GEM_b1", "3300025882_39"],
            [275362, "o__binchicken_b1", "SRP141376_co3_207"],
            [275365, "f__GEM_b1", "3300025882_39"],
            [None, "f__SPIRE_b1", "spire_mag_02020990"],
            [None, "f__binchicken_b1", "SRP141376_co3_207"],
            [None, "f__binchicken_b2", "ERP107533_co1_57"],
            [275367, "g__GEM_b1", "3300025882_39"],
            [None, "g__SPIRE_b1", "spire_mag_02020990"],
            [None, "g__SPIRE_b2", "spire_mag_01765318"],
            [None, "g__binchicken_b1", "binchicken_co117_471"],
            [None, "g__binchicken_b2", "SRP141376_co3_207"],
            [None, "g__binchicken_b3", "ERP107533_co1_57"],
            [None, "s__GEM_b1 3300025882_39", "3300025882_39"],
            [None, "s__SPIRE_b1 spire_mag_02020990", "spire_mag_02020990"],
            [None, "s__SPIRE_b2 spire_mag_01765318", "spire_mag_01765318"],
            [None, "s__GEM_b1 binchicken_co111_474", "binchicken_co111_474"],
            [None, "s__binchicken_b1 binchicken_co117_471", "binchicken_co117_471"],
            [None, "s__binchicken_b2 SRP141376_co3_207", "SRP141376_co3_207"],
            [None, "s__binchicken_b3 ERP107533_co1_57", "ERP107533_co1_57"],
        ], schema=NODES_OUTPUT_COLUMNS)
    ...
    def test_name_clades_extra_family(self):
        ...
        expected_genomes = pl.DataFrame([
            ["spire_mag_00098172", "312372;g__SPIRE_b1;s__SPIRE_b1 spire_mag_00098172"],
            ["spire_mag_00098246", "312379;g__SPIRE_b5;s__SPIRE_b5 spire_mag_00098246"],
            ["spire_mag_01799640", "312372;g__SPIRE_b1;s__SPIRE_b1 spire_mag_01799640"],
            ["spire_mag_01799662", "312361;f__SPIRE_b1;g__SPIRE_b2;s__SPIRE_b2 spire_mag_01799662"],
            ["spire_mag_01799808", "312361;f__SPIRE_b1;g__SPIRE_b4;s__SPIRE_b4 spire_mag_01799808"],
            ["spire_mag_01799858", "312372;g__SPIRE_b1;s__SPIRE_b1 spire_mag_01799858"],
            ["spire_mag_01799939", "312361;f__SPIRE_b1;g__SPIRE_b3;s__SPIRE_b3 spire_mag_01799939"],
            ["3300017485_6", "312361;f__GEM_b1;g__GEM_b1;s__GEM_b1 3300017485_6"],
            ["ERP119705_co25_475", "312371;g__binchicken_b6;s__binchicken_b6 ERP119705_co25_475"],
            ["ERP125453_co1_503", "312372;g__SPIRE_b1;s__SPIRE_b1 ERP125453_co1_503"],
            ["SRP090828_co1_1", "312377;g__binchicken_b4;s__binchicken_b4 SRP090828_co1_1"],
            ["SRP124282_co5_22", "312369;g__binchicken_b3;s__binchicken_b3 SRP124282_co5_22"],
            ["SRP124282_co5_49", "312361;f__binchicken_b1;g__binchicken_b1;s__binchicken_b1 SRP124282_co5_49"],
            ["SRP124282_co6_56", "312361;f__SPIRE_b1;g__binchicken_b5;s__binchicken_b5 SRP124282_co6_56"],
            ["SRP269290_co5_116", "312373"],
            ["binchicken_co203_435", "312377;g__binchicken_b4;s__binchicken_b4 binchicken_co203_435"],
            ["binchicken_co203_446", "312361;f__binchicken_b1;g__binchicken_b2;s__binchicken_b2 binchicken_co203_446"],
        ], schema=GENOMES_OUTPUT_COLUMNS)
        expected_nodes = pl.DataFrame([
            [None, "f__GEM_b1", "3300017485_6"],
            [312365, "f__SPIRE_b1", "spire_mag_01799662"],
            [312364, "f__binchicken_b1", "SRP124282_co5_49"],
            [312374, "g__SPIRE_b1", "spire_mag_01799858"],
            [312378, "g__binchicken_b4", "binchicken_co203_435"],
            [None, "g__GEM_b1", "3300017485_6"],
            [None, "g__SPIRE_b2", "spire_mag_01799662"],
            [None, "g__SPIRE_b3", "spire_mag_01799939"],
            [None, "g__SPIRE_b4", "spire_mag_01799808"],
            [None, "g__SPIRE_b5", "spire_mag_00098246"],
            [None, "g__binchicken_b1", "SRP124282_co5_49"],
            [None, "g__binchicken_b2", "binchicken_co203_446"],
            [None, "g__binchicken_b3", "SRP124282_co5_22"],
            [None, "g__binchicken_b5", "SRP124282_co6_56"],
            [None, "g__binchicken_b6", "ERP119705_co25_475"],
            [None, "s__GEM_b1 3300017485_6", "3300017485_6"],
            [None, "s__SPIRE_b1 ERP125453_co1_503", "ERP125453_co1_503"],
            [None, "s__SPIRE_b1 spire_mag_00098172", "spire_mag_00098172"],
            [None, "s__SPIRE_b1 spire_mag_01799640", "spire_mag_01799640"],
            [None, "s__SPIRE_b1 spire_mag_01799858", "spire_mag_01799858"],
            [None, "s__SPIRE_b2 spire_mag_01799662", "spire_mag_01799662"],
            [None, "s__SPIRE_b3 spire_mag_01799939", "spire_mag_01799939"],
            [None, "s__SPIRE_b4 spire_mag_01799808", "spire_mag_01799808"],
            [None, "s__SPIRE_b5 spire_mag_00098246", "spire_mag_00098246"],
            [None, "s__binchicken_b1 SRP124282_co5_49", "SRP124282_co5_49"],
            [None, "s__binchicken_b2 binchicken_co203_446", "binchicken_co203_446"],
            [None, "s__binchicken_b3 SRP124282_co5_22", "SRP124282_co5_22"],
            [None, "s__binchicken_b4 SRP090828_co1_1", "SRP090828_co1_1"],
            [None, "s__binchicken_b4 binchicken_co203_435", "binchicken_co203_435"],
            [None, "s__binchicken_b5 SRP124282_co6_56", "SRP124282_co6_56"],
            [None, "s__binchicken_b6 ERP119705_co25_475", "ERP119705_co25_475"],
        ], schema=NODES_OUTPUT_COLUMNS)
    ...
    def test_name_clades_many_phyla(self):
        ...
        expected_genomes = pl.DataFrame([
            ...
            ["binchicken_co122_247", "24277;g__binchicken_a1;s__binchicken_a1 binchicken_co122_247"],
            ["binchicken_co243_184", "24278"],
            ["binchicken_co181_128", "24278"],
        ], schema=GENOMES_OUTPUT_COLUMNS)
        expected_nodes = pl.DataFrame([
            [None, "g__binchicken_a1", "binchicken_co122_247"],
            [None, "s__binchicken_a1 binchicken_co122_247", "binchicken_co122_247"],
        ], schema=NODES_OUTPUT_COLUMNS)
    ...
    def test_name_clades_not_copied(self):
        ...
        expected_genomes = pl.DataFrame([
            ...
            ["spire_mag_00097715", "2672;g__SPIRE_a4;s__SPIRE_a4 spire_mag_00097715"],
            ["spire_mag_00175199", "2667;g__SPIRE_a5;s__SPIRE_a5 spire_mag_00175199"],
            ["spire_mag_00175299", "2664;f__SPIRE_a2;g__SPIRE_a2;s__SPIRE_a2 spire_mag_00175299"],
            ["spire_mag_00186175", "2666;f__SPIRE_a3;g__SPIRE_a3;s__SPIRE_a3 spire_mag_00186175"],
            ["spire_mag_00707902", "2662;o__SPIRE_a1;f__SPIRE_a1;g__SPIRE_a1;s__SPIRE_a1 spire_mag_00707902"],
            ["3300025462_33", "2678"],
            ["GCA_038891875.1_ASM3889187v1_genomic", "2670;g__Tengchong_a1;s__Tengchong_a1 GCA_038891875.1_ASM3889187v1_genomic"],
            ["GCA_038735675.1_ASM3873567v1_genomic", "2670;g__Tengchong_a1;s__Tengchong_a1 GCA_038735675.1_ASM3873567v1_genomic"],
            ["SRP144503_co2_142", "2662;o__SPIRE_a1;f__SPIRE_a1;g__binchicken_a2;s__binchicken_a2 SRP144503_co2_142"],
            ["SRP144503_co3_139", "2662;o__SPIRE_a1;f__binchicken_a1;g__binchicken_a1;s__binchicken_a1 SRP144503_co3_139"],
            ["binchicken_co291_17", "2662;o__SPIRE_a1;f__binchicken_a1;g__binchicken_a1;s__binchicken_a1 binchicken_co291_17"],
            ["binchicken_co381_152", "2667;g__SPIRE_a5;s__SPIRE_a5 binchicken_co381_152"],
        ], schema=GENOMES_OUTPUT_COLUMNS)
        expected_nodes = pl.DataFrame([
            [2686, "f__SPIRE_a1", "spire_mag_00707902"],
            [None, "f__SPIRE_a2", "spire_mag_00175299"],
            [None, "f__SPIRE_a3", "spire_mag_00186175"],
            [2685, "f__binchicken_a1", "binchicken_co291_17"],
            [None, "g__SPIRE_a1", "spire_mag_00707902"],
            [None, "g__SPIRE_a2", "spire_mag_00175299"],
            [None, "g__SPIRE_a3", "spire_mag_00186175"],
            [None, "g__SPIRE_a4", "spire_mag_00097715"],
            [2668, "g__SPIRE_a5", "spire_mag_00175199"],
            [2671, "g__Tengchong_a1", "GCA_038735675.1_ASM3873567v1_genomic"],
            [2685, "g__binchicken_a1", "binchicken_co291_17"],
            [None, "g__binchicken_a2", "SRP144503_co2_142"],
            [2684, "o__SPIRE_a1", "spire_mag_00707902"],
            [None, "s__SPIRE_a1 spire_mag_00707902", "spire_mag_00707902"],
            [None, "s__SPIRE_a2 spire_mag_00175299", "spire_mag_00175299"],
            [None, "s__SPIRE_a3 spire_mag_00186175", "spire_mag_00186175"],
            [None, "s__SPIRE_a4 spire_mag_00097715", "spire_mag_00097715"],
            [None, "s__SPIRE_a5 binchicken_co381_152", "binchicken_co381_152"],
            [None, "s__SPIRE_a5 spire_mag_00175199", "spire_mag_00175199"],
            [None, "s__Tengchong_a1 GCA_038735675.1_ASM3873567v1_genomic", "GCA_038735675.1_ASM3873567v1_genomic"],
            [None, "s__Tengchong_a1 GCA_038891875.1_ASM3889187v1_genomic", "GCA_038891875.1_ASM3889187v1_genomic"],
            [None, "s__binchicken_a1 SRP144503_co3_139", "SRP144503_co3_139"],
            [None, "s__binchicken_a1 binchicken_co291_17", "binchicken_co291_17"],
            [None, "s__binchicken_a2 SRP144503_co2_142", "SRP144503_co2_142"],
        ], schema=NODES_OUTPUT_COLUMNS)
