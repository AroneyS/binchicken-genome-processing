...
theme_set(theme_tree(font_family = "Arial"))
theme_set(theme_tree2(font_family = "Arial"))
...
bacterial_order_congruency %>%
  ...
  mutate(
    plot = map_lgl(label, ~ plot_iqtree_subset(., bacterial$order_tree, bacterial_congruency, "bacterial_order"))
  )

bacterial_class_congruency %>%
  filter(phylum_congruency == "incongruent" | class_congruency == "incongruent") %>%
  mutate(
    plot = map_lgl(label, ~ plot_iqtree_subset(., bacterial$class_tree, bacterial_congruency, "bacterial_class"))
  )
...
archaeal_order_congruency %>%
  filter(phylum_congruency == "incongruent" | class_congruency == "incongruent") %>%
  mutate(
    plot = map_lgl(label, ~ plot_iqtree_subset(., archaeal$order_tree, archaeal_congruency, "archaeal_order"))
  )

archaeal_class_congruency %>%
  filter(phylum_congruency == "incongruent" | class_congruency == "incongruent") %>%
  mutate(
    plot = map_lgl(label, ~ plot_iqtree_subset(., archaeal$class_tree, archaeal_congruency, "archaeal_class"))
  )
